        ...
        try {
            ...
            while (reader.hasNextLine()) {
                ...
                if(tempOne/1000 == tempTwo/1000) {
                    ...
                    for(int i = 0; i < length; i++) {
                        int value = (tempOne + i*1000 - i);
                        if(twoPlus.contains(value)) {
                        }
                        else if(oneInstance.contains(value)) {
                            oneInstance.remove(new Integer(value));
                            twoPlus.add(value);
                            dangerVolume += 1;
                        }
                        else {
                            oneInstance.add(value);
                        }
                    }
                }
                else {
